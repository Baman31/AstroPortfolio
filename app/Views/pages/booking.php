...
<section class="py-16">
    <div class="container mx-auto px-4 max-w-3xl">
        <h1 class="text-5xl font-heading font-bold text-center mb-8 text-deep-blue">Book a Consultation</h1>
        ...
        <div class="card">
            <form method="POST" action="/booking/submit" x-data="{ currency: 'inr' }">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2">Meeting Mode *</label>
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 font-semibold mb-2">Currency for Payment *</label>
